...
export const IconDocumentDoc = ({ block }: IconInfoProps) => (
  <Icon viewBox="0 0 16 16" block={block}>
    <path d="M15 .5c0-.3-.2-.5-.5-.5h-13c-.3 0-.5.2-.5.5v15c0 .3.2.5.5.5h8.2c.1 0 .1-.1.2-.1l5-5s.1-.1.1-.2V.5zM2 1h12v9H9.5c-.3 0-.5.2-.5.5V15H2V1zm11.3 10L10 14.3V11h3.3zM4 4.5c0-.3.2-.5.5-.5h7c.3 0 .5.2.5.5s-.2.5-.5.5h-7c-.3 0-.5-.2-.5-.5zm0 3c0-.3.2-.5.5-.5h7c.3 0 .5.2.5.5s-.2.5-.5.5h-7c-.3 0-.5-.2-.5-.5zm3 3c0 .3-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h2c.3 0 .5.2.5.5z" />
  </Icon>
);

export const IconDocumentPdf = ({ block }: IconInfoProps) => (
  <Icon viewBox="0 0 16 16" block={block}>
    <path d="M14.5 0h-13c-.3 0-.5.2-.5.5v15c0 .3.2.5.5.5h8.2c.1 0 .1-.1.2-.1l5-5s.1-.1.1-.2V.5c0-.3-.2-.5-.5-.5zM10 14.3V11h3.3L10 14.3zm4-4.3H9.5c-.3 0-.5.2-.5.5V15H2V1h12v9zM9 4.5c0-.3.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5zM5.5 8h1C7.3 8 8 7.3 8 6.5v-1C8 4.7 7.3 4 6.5 4h-1C4.7 4 4 4.7 4 5.5v1C4 7.3 4.7 8 5.5 8zM5 5.5c0-.3.2-.5.5-.5h1c.3 0 .5.2.5.5v1c0 .3-.2.5-.5.5h-1c-.3 0-.5-.2-.5-.5v-1zm4 2c0-.3.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5zm-5 3c0-.3.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5z" />
  </Icon>
);
export const IconDocumentUnknown = ({ block }: IconInfoProps) => (
  <Icon viewBox="0 0 16 16" block={block}>
    <path d="M14.5 0h-13c-.3 0-.5.2-.5.5v15c0 .3.2.5.5.5h8.2c.1 0 .1-.1.2-.1l5-5s.1-.1.1-.2V.5c0-.3-.2-.5-.5-.5zM10 14.3V11h3.3L10 14.3zm4-4.3H9.5c-.3 0-.5.2-.5.5V15H2V1h12v9z" />
  </Icon>
);

export const IconDocumentXls = ({ block }: IconInfoProps) => (
  <Icon viewBox="0 0 16 16" block={block}>
    <path d="M15 .5c0-.3-.2-.5-.5-.5h-13c-.3 0-.5.2-.5.5v15c0 .3.2.5.5.5h8.2c.1 0 .1-.1.2-.1l5-5s.1-.1.1-.2V.5zM2 1h12v9H9.5c-.3 0-.5.2-.5.5V15H2V1zm11.3 10L10 14.3V11h3.3zM4 4.5c0-.3.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5zm5 0c0-.3.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5zm-2 6c0 .3-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h2c.3 0 .5.2.5.5zm0-3c0 .3-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h2c.3 0 .5.2.5.5zm2 0c0-.3.2-.5.5-.5h2c.3 0 .5.2.5.5s-.2.5-.5.5h-2c-.3 0-.5-.2-.5-.5z" />
  </Icon>
);
